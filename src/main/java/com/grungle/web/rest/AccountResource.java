...
import com.grungle.service.MailService;
import com.grungle.service.RegistrationService;
import com.grungle.service.UserService;
import com.grungle.web.rest.dto.UserDTO;
    ...
    public ResponseEntity<?> registerAccount(@Valid @RequestBody UserDTO userDTO, HttpServletRequest request) {
        return userRepository.findOneByLogin(userDTO.getLogin())
                ...
                .orElseGet(() -> userRepository.findOneByLogin(userDTO.getLogin())
                                ...
                                .orElseGet(() -> {
                                    User user = registrationService.registerUser(userDTO.getLogin(), userDTO.getPassword(),
